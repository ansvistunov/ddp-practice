...
public class BasicCarServer implements CarServer {
    ...
    public static final int maxCarSecondsDonNotMove = 30;

    public static BasicCarServer getServer(){return carServer;}
    public static  BasicCarServer createCarServer(FieldMatrix fieldMatrix, CarEventsListener carEventsListener){
        return new BasicCarServer(fieldMatrix,carEventsListener);
    }
